...
class Agenda(Resource):
    ...
    @jwt_required()
    def get(self):
        logging.debug(f"GET request at: /agenda")
    ...
    def post(self):
        logging.debug(f"POST request at: /agenda")
